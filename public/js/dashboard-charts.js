    ...
    function switchTab(tabId) {
        ...
        // Re-animate progress bars and counters when switching tabs
        setTimeout(() => {
            animateProgressBars();
            if (tabId === 'inicio') animateCounters();
        }, 100);
    ...
    // ===== CHART.JS CONFIG =====
    Chart.defaults.color = '#a89cc8';
    Chart.defaults.borderColor = 'rgba(124, 58, 237, 0.1)';
    ...
    function initPanoramaCharts() {
        ...
        const el = document.getElementById('panoramaPieChart'); if(!el) return; const pieCtx = el.getContext('2d');
        ...
        const el2 = document.getElementById('panoramaLineChart'); if(!el2) return; const lineCtx = el2.getContext('2d');
    ...
    function initRegiaoCharts() {
        ...
        const el3 = document.getElementById('regiaoBarChart'); if(!el3) return; const barCtx = el3.getContext('2d');
        ...
        const el4 = document.getElementById('regiaoRateChart'); if(!el4) return; const rateCtx = el4.getContext('2d');
    ...
    function initTemporalCharts() {
        ...
        const el5 = document.getElementById('temporalLineChart'); if(!el5) return; const histCtx = el5.getContext('2d');
        ...
        const el6 = document.getElementById('temporalBarChart'); if(!el6) return; const femCtx = el6.getContext('2d');
        ...
        const el7 = document.getElementById('temporalRadarChart'); if(!el7) return; const radarCtx = el7.getContext('2d');
    ...
    function initPerfilCharts() {
        ...
        const el8 = document.getElementById('perfilAgeChart'); if(!el8) return; const ageCtx = el8.getContext('2d');
        ...
        const el9 = document.getElementById('perfilEducationChart'); if(!el9) return; const eduCtx = el9.getContext('2d');
        ...
        const el10 = document.getElementById('perfilWorkChart'); if(!el10) return; const workCtx = el10.getContext('2d');
        ...
        const el11 = document.getElementById('perfilRaceChart'); if(!el11) return; const raceCtx = el11.getContext('2d');
